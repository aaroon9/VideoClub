...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayPeliculas = array(
		...
		array(
			...
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/51iggHFltnL.jpg',
			'rented' => true,
		...
		array(
			...
			'year' => '1987',
			'director' => 'Stanley Kubrick',
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/5130SZS3CxL._SY450_.jpg',
			'rented' => true,
		...
		array(
			...
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/61EVlwySk%2BL.jpg',
			'rented' => true,
		...
		array(
			...
			'year' => '1999',
			'director' => 'David Fincher',
			'poster' => 'https://mm3.vistoenpantalla.com/imagenes-productos/poster2-large2.jpg',
			'rented' => true,
    ...
    private function seedUsers(){
    	...
    	$user1 = new User;
    	$user1->name ='Adrian';
    	$user1->email ='avalera@gmail.com';
    	$user1->password = bcrypt('hola1');
    	$user1->save();

    	$user2 = new User;
    	$user2->name = 'Paco';
    	$user2->email = 'pMartinez@gmail.com';
    	$user2->password = bcrypt('paquito');
    	$user2->save();

      $user2 = new User;
    	$user2->name = 'Xavi';
    	$user2->email = 'xavi@franch.com';
    	$user2->password = bcrypt('xavifranch');
    	$user2->save();
    }
